...
Euk_reads_from_kraken_filename = sys.argv[3]
...
#reading the list of ids that kraken considered Eukariotic
Euk_reads_from_kraken = set(line.strip() for line in open(Euk_reads_from_kraken_filename))
